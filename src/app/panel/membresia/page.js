    ...
    <main className="min-h-screen bg-black text-white">
      <section className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
          ...
          <aside className="rounded-[2rem] border border-yellow-500/20 bg-yellow-500/10 p-6">
            ...
            <p className="mt-3 text-sm leading-6 text-yellow-100">
              ...
              membresía no se activa desde la web: se activa cuando Mercado Pago
              confirme el pago por webhook.
            </p>
